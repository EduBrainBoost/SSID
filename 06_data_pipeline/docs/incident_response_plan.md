# Incident Response Plan - 06_data_pipeline
...
This Incident Response Plan (IRP) defines the procedures for detecting, responding to, and recovering from security incidents affecting the **06_data_pipeline** component of the SSID infrastructure.

### Scope
- All systems, services, and data within **06_data_pipeline**
