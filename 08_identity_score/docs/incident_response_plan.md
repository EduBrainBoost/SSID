# Incident Response Plan - 08_identity_score
...
This Incident Response Plan (IRP) defines the procedures for detecting, responding to, and recovering from security incidents affecting the **08_identity_score** component of the SSID infrastructure.

### Scope
- All systems, services, and data within **08_identity_score**
