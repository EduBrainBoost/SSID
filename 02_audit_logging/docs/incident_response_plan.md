# Incident Response Plan - 02_audit_logging
...
This Incident Response Plan (IRP) defines the procedures for detecting, responding to, and recovering from security incidents affecting the **02_audit_logging** component of the SSID infrastructure.

### Scope
- All systems, services, and data within **02_audit_logging**
