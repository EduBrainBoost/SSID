# Incident Response Plan - 22_datasets
...
This Incident Response Plan (IRP) defines the procedures for detecting, responding to, and recovering from security incidents affecting the **22_datasets** component of the SSID infrastructure.

### Scope
- All systems, services, and data within **22_datasets**
