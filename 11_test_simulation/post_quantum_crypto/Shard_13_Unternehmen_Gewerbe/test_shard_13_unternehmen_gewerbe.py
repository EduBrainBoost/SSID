"""Tests for Shard_13_Unternehmen_Gewerbe"""
import pytest
from pathlib import Path
import yaml

# Go to project root, then to the actual shard location
SHARD = Path(__file__).parent.parent.parent.parent / "21_post_quantum_crypto/shards/Shard_13_Unternehmen_Gewerbe"
...
def test_chart_yaml_valid():
    ...
    assert chart["metadata"]["shard_id"] == "Shard_13_Unternehmen_Gewerbe"
