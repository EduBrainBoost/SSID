...
# ============================================================
# MISSING MD-* RULES (5 rules)
# ============================================================

# MD-CHART-029: chart.yaml SOLLTE orchestration.workflows definieren
# Severity: MEDIUM
# Category: CHART_STRUCTURE
# Input: { "chart": { "orchestration": ... } }
deny[msg] {
    not input["orchestration"]["workflows"]
    msg := sprintf("MD-CHART-029 VIOLATION: chart.yaml missing required field 'orchestration.workflows'", [])
}
...
# Input: { "chart": { "roadmap": ... } }
deny[msg] {
    not input["roadmap"]["upcoming"]
    msg := sprintf("MD-CHART-050 VIOLATION: chart.yaml missing required field 'roadmap.upcoming'", [])
}
...
deny[msg] {
    not input["artifacts"]["models"]["location"]
    msg := sprintf("MD-MANIFEST-013 VIOLATION: manifest.yaml missing required field 'artifacts.models.location'", [])
}
...
# Input: { "manifest": { "artifacts": ... } }
deny[msg] {
    not input["artifacts"]["protocols"]["location"]
    msg := sprintf("MD-MANIFEST-014 VIOLATION: manifest.yaml missing required field 'artifacts.protocols.location'", [])
}
...
# SOT-V2-0091: Semantic rule for 'grundprinzipien.ausnahmen.allowed_root_files'.
# Severity: CRITICAL
# Category: STRUCTURE
# Input: { "structure": { ... } }
deny[msg] {
    # TODO: Implement specific validation logic for SOT-V2-0091
    # This is a placeholder - actual logic depends on rule requirements
    false  # Placeholder - always passes until implemented
    msg := sprintf("SOT-V2-0091 VIOLATION: Semantic rule for 'grundprinzipien.ausnahmen.allowed_root_files'.", [])
}

# SOT-V2-0092: Semantic rule for 'grundprinzipien.critical.structure_exceptions_yaml'.
# Severity: CRITICAL
# Category: STRUCTURE
# Input: { "structure": { ... } }
deny[msg] {
    # TODO: Implement specific validation logic for SOT-V2-0092
    # This is a placeholder - actual logic depends on rule requirements
    false  # Placeholder - always passes until implemented
    msg := sprintf("SOT-V2-0092 VIOLATION: Semantic rule for 'grundprinzipien.critical.structure_exceptions_yaml'.", [])
}

# SOT-V2-0093: Semantic rule for 'grundprinzipien.root_level_ausnahmen'.
# Severity: CRITICAL
# Category: STRUCTURE
# Input: { "structure": { ... } }
deny[msg] {
    # TODO: Implement specific validation logic for SOT-V2-0093
    # This is a placeholder - actual logic depends on rule requirements
    false  # Placeholder - always passes until implemented
    msg := sprintf("SOT-V2-0093 VIOLATION: Semantic rule for 'grundprinzipien.root_level_ausnahmen'.", [])
}

# SOT-V2-0094: Semantic rule for 'grundprinzipien.verbindliche_root_module'.
# Severity: CRITICAL
# Category: STRUCTURE
# Input: { "structure": { ... } }
deny[msg] {
    # TODO: Implement specific validation logic for SOT-V2-0094
    # This is a placeholder - actual logic depends on rule requirements
    false  # Placeholder - always passes until implemented
    msg := sprintf("SOT-V2-0094 VIOLATION: Semantic rule for 'grundprinzipien.verbindliche_root_module'.", [])
}
