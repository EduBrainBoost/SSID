# Incident Response Plan - 23_compliance
...
This Incident Response Plan (IRP) defines the procedures for detecting, responding to, and recovering from security incidents affecting the **23_compliance** component of the SSID infrastructure.

### Scope
- All systems, services, and data within **23_compliance**
