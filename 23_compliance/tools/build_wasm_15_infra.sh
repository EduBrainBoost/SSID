#!/usr/bin/env bash
# WASM Build Script - 15_infra Policy
...
# Configuration
POLICY="23_compliance/policies/15_infra_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/15infra/v6_0"
OUT_FILE="15_infra_v6_0.wasm"

echo "=== Building WASM for 15_infra Policy ==="
...
echo "[OK] 15_infra WASM build successful"
