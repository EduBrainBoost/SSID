#!/usr/bin/env bash
# WASM Build Script - 11_test_simulation Policy
...
# Configuration
POLICY="23_compliance/policies/11_test_simulation_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/11testsimulation/v6_0"
OUT_FILE="11_test_simulation_v6_0.wasm"

echo "=== Building WASM for 11_test_simulation Policy ==="
...
echo "[OK] 11_test_simulation WASM build successful"
