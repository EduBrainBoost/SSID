#!/usr/bin/env bash
# WASM Build Script - 02_audit_logging Policy
...
# Configuration
POLICY="23_compliance/policies/02_audit_logging_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/02auditlogging/v6_0"
OUT_FILE="02_audit_logging_v6_0.wasm"

echo "=== Building WASM for 02_audit_logging Policy ==="
...
echo "[OK] 02_audit_logging WASM build successful"
