#!/usr/bin/env bash
# WASM Build Script - 07_governance_legal Policy
...
# Configuration
POLICY="23_compliance/policies/07_governance_legal_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/07governancelegal/v6_0"
OUT_FILE="07_governance_legal_v6_0.wasm"

echo "=== Building WASM for 07_governance_legal Policy ==="
...
echo "[OK] 07_governance_legal WASM build successful"
