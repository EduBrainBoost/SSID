#!/usr/bin/env bash
# WASM Build Script - 12_tooling Policy
...
# Configuration
POLICY="23_compliance/policies/12_tooling_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/12tooling/v6_0"
OUT_FILE="12_tooling_v6_0.wasm"

echo "=== Building WASM for 12_tooling Policy ==="
...
echo "[OK] 12_tooling WASM build successful"
