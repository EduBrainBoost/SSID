#!/usr/bin/env bash
# WASM Build Script - 16_codex Policy
...
# Configuration
POLICY="23_compliance/policies/16_codex_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/16codex/v6_0"
OUT_FILE="16_codex_v6_0.wasm"

echo "=== Building WASM for 16_codex Policy ==="
...
echo "[OK] 16_codex WASM build successful"
