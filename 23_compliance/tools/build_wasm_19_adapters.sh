#!/usr/bin/env bash
# WASM Build Script - 19_adapters Policy
...
# Configuration
POLICY="23_compliance/policies/19_adapters_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/19adapters/v6_0"
OUT_FILE="19_adapters_v6_0.wasm"

echo "=== Building WASM for 19_adapters Policy ==="
...
echo "[OK] 19_adapters WASM build successful"
