#!/usr/bin/env bash
# WASM Build Script - 06_data_pipeline Policy
...
# Configuration
POLICY="23_compliance/policies/06_data_pipeline_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/06datapipeline/v6_0"
OUT_FILE="06_data_pipeline_v6_0.wasm"

echo "=== Building WASM for 06_data_pipeline Policy ==="
...
echo "[OK] 06_data_pipeline WASM build successful"
