#!/usr/bin/env bash
# WASM Build Script - 01_ai_layer Policy
...
# Configuration
POLICY="23_compliance/policies/01_ai_layer_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/01ailayer/v6_0"
OUT_FILE="01_ai_layer_v6_0.wasm"

echo "=== Building WASM for 01_ai_layer Policy ==="
...
echo "[OK] 01_ai_layer WASM build successful"
