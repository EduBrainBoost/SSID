#!/usr/bin/env bash
# WASM Build Script - 13_ui_layer Policy
...
# Configuration
POLICY="23_compliance/policies/13_ui_layer_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/13uilayer/v6_0"
OUT_FILE="13_ui_layer_v6_0.wasm"

echo "=== Building WASM for 13_ui_layer Policy ==="
...
echo "[OK] 13_ui_layer WASM build successful"
