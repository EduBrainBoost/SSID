#!/usr/bin/env bash
# WASM Build Script - 21_post_quantum_crypto Policy
...
# Configuration
POLICY="23_compliance/policies/21_post_quantum_crypto_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/21postquantumcrypto/v6_0"
OUT_FILE="21_post_quantum_crypto_v6_0.wasm"

echo "=== Building WASM for 21_post_quantum_crypto Policy ==="
...
echo "[OK] 21_post_quantum_crypto WASM build successful"
