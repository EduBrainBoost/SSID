#!/usr/bin/env bash
# WASM Build Script - 20_foundation Policy
...
# Configuration
POLICY="23_compliance/policies/20_foundation_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/20foundation/v6_0"
OUT_FILE="20_foundation_v6_0.wasm"

echo "=== Building WASM for 20_foundation Policy ==="
...
echo "[OK] 20_foundation WASM build successful"
