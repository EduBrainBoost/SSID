#!/usr/bin/env bash
# WASM Build Script - 18_data_layer Policy
...
# Configuration
POLICY="23_compliance/policies/18_data_layer_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/18datalayer/v6_0"
OUT_FILE="18_data_layer_v6_0.wasm"

echo "=== Building WASM for 18_data_layer Policy ==="
...
echo "[OK] 18_data_layer WASM build successful"
