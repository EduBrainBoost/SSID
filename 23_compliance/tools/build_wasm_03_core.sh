#!/usr/bin/env bash
# WASM Build Script - 03_core Policy
...
# Configuration
POLICY="23_compliance/policies/03_core_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/03_core/v6_0"
OUT_FILE="03_core_v6_0.wasm"

echo "=== Building WASM for 03_core Policy ==="
...
echo "✅ 03_core WASM build successful"
