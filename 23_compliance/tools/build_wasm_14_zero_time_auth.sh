#!/usr/bin/env bash
# WASM Build Script - 14_zero_time_auth Policy
...
# Configuration
POLICY="23_compliance/policies/14_zero_time_auth_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/14zerotimeauth/v6_0"
OUT_FILE="14_zero_time_auth_v6_0.wasm"

echo "=== Building WASM for 14_zero_time_auth Policy ==="
...
echo "[OK] 14_zero_time_auth WASM build successful"
