#!/usr/bin/env bash
# WASM Build Script - 17_observability Policy
...
# Configuration
POLICY="23_compliance/policies/17_observability_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/17observability/v6_0"
OUT_FILE="17_observability_v6_0.wasm"

echo "=== Building WASM for 17_observability Policy ==="
...
echo "[OK] 17_observability WASM build successful"
