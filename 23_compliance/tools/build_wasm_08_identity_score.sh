#!/usr/bin/env bash
# WASM Build Script - 08_identity_score Policy
...
# Configuration
POLICY="23_compliance/policies/08_identity_score_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/08identityscore/v6_0"
OUT_FILE="08_identity_score_v6_0.wasm"

echo "=== Building WASM for 08_identity_score Policy ==="
...
echo "[OK] 08_identity_score WASM build successful"
