#!/usr/bin/env bash
# WASM Build Script - 10_interoperability Policy
...
# Configuration
POLICY="23_compliance/policies/10_interoperability_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/10interoperability/v6_0"
OUT_FILE="10_interoperability_v6_0.wasm"

echo "=== Building WASM for 10_interoperability Policy ==="
...
echo "[OK] 10_interoperability WASM build successful"
