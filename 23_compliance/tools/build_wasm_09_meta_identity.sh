#!/usr/bin/env bash
# WASM Build Script - 09_meta_identity Policy
...
# Configuration
POLICY="23_compliance/policies/09_meta_identity_policy_stub_v6_0.rego"
OUT_DIR="23_compliance/wasm"
ENTRYPOINT="ssid/09metaidentity/v6_0"
OUT_FILE="09_meta_identity_v6_0.wasm"

echo "=== Building WASM for 09_meta_identity Policy ==="
...
echo "[OK] 09_meta_identity WASM build successful"
