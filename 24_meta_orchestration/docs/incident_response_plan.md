# Incident Response Plan - 24_meta_orchestration
...
This Incident Response Plan (IRP) defines the procedures for detecting, responding to, and recovering from security incidents affecting the **24_meta_orchestration** component of the SSID infrastructure.

### Scope
- All systems, services, and data within **24_meta_orchestration**
