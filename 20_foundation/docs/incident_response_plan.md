# Incident Response Plan - 20_foundation
...
This Incident Response Plan (IRP) defines the procedures for detecting, responding to, and recovering from security incidents affecting the **20_foundation** component of the SSID infrastructure.

### Scope
- All systems, services, and data within **20_foundation**
