# Incident Response Plan - 21_post_quantum_crypto
...
This Incident Response Plan (IRP) defines the procedures for detecting, responding to, and recovering from security incidents affecting the **21_post_quantum_crypto** component of the SSID infrastructure.

### Scope
- All systems, services, and data within **21_post_quantum_crypto**
