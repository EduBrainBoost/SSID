# Incident Response Plan - 07_governance_legal
...
This Incident Response Plan (IRP) defines the procedures for detecting, responding to, and recovering from security incidents affecting the **07_governance_legal** component of the SSID infrastructure.

### Scope
- All systems, services, and data within **07_governance_legal**
